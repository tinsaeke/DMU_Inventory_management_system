...
export default function StaffNotificationsPage() {
  ...
  const { data: notifications = [] } = useQuery({
    queryKey: ['staff-notifications', profile?.id],
    queryFn: async () => {
  ...
  return (
    <DashboardLayout
      ...
      pageSubtitle="Stay updated on your requests and items"
    >
        ...
        {notifications.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground">
              You'll see notifications about your requests and items here.
            </p>
          </div>
        )}
      </div>
