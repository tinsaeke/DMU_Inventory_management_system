    ...
    extend: {
      ...
      colors: {
        ...
        role: {
          ...
          dean: "hsl(var(--role-dean))",
          department: "hsl(var(--role-department))",
          storekeeper: "hsl(var(--role-storekeeper))",
      ...
      boxShadow: {
        'institutional': '0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1)',
